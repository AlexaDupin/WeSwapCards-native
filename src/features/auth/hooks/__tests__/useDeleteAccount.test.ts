...
//
// Confirmation is not tested here: it lives in DeleteAccountDialog, because the
// acknowledgement tick box cannot be expressed as an Alert.
...
describe('useDeleteAccount', () => {
  it('deletes, clears local state, signs out, and navigates home', async () => {
